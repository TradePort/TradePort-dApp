                ...
                <div className="columns is-account-grid is-multiline">
                  <div className="column is-5">
                    ...
                    <div className="flat-card profile-info-card is-auto is-dark is-achievement">
                      <div className="card-body">
                        ...
                        <div className="achievement-name">
                          ...
                          <span>
                            As a Gold Customer, you have a permanent 10%
                    ...
                    <div className="flat-card profile-info-card is-auto is-dark is-achievement">
                      <div className="card-body">
                        <img
                          src="assets/images/logo/nephos-referral.svg"
                          alt=""
                        />
                        <div className="achievement-name">
                          <span className="is-green">Nephos Referer</span>
                          <span>
                            You have referred <b>30+</b> customers. You get a
                            2.5% discount on all your purchases.
                          </span>
                        </div>
                      </div>
                    </div>
